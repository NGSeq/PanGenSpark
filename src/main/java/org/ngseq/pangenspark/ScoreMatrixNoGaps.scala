...
object ScoreMatrixNoGaps {
  ...
  def main(args: Array[String]) {
    ...
    */
    ...
    /*val hp = blocks.transpose.toIndexedRowMatrix().rows.map(row => {
      row.vector.argmax
    })*/
